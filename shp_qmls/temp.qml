...
<qgis version="2.18.19" simplifyAlgorithm="0" minimumScale="0" maximumScale="0" simplifyDrawingHints="0" minLabelScale="1" maxLabelScale="1e+08" simplifyDrawingTol="1" readOnly="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <edittypes>
    ...
    <edittype widgetv2type="TextEdit" name="Celsius">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
  ...
  <renderer-v2 attr="&quot;Celsius&quot;" forceraster="0" symbollevels="0" type="graduatedSymbol" graduatedMethod="GraduatedColor" enableorderby="0">
    <ranges>
  ...
  <customproperties>
    ...
    <property key="labeling/fieldName" value="Station +  to_string('\n') + to_string(&quot;Celsius&quot;) + '°C'"/>
  ...
  <aliases>
    <alias field="Lon" index="0" name=""/>
    <alias field="Celsius" index="1" name=""/>
    <alias field="Date" index="2" name=""/>
    <alias field="Station" index="3" name=""/>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="&quot;City&quot;" sortOrder="0">
    <columns>
      ...
      <column width="-1" hidden="0" type="field" name="Celsius"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <defaults>
    ...
    <default field="Celsius" expression=""/>
    <default field="Date" expression=""/>
    <default field="Station" expression=""/>
